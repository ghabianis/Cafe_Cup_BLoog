    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    <p>Phone:
                        <strong>+21690770350</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:info@theperfectcup.com">anisghabi8@gmail.com</a></strong>
                    </p>
                    <p>Address:
                        <strong>Sidi Bouzid
                            <br>Tunsia | Sid Bouzid Jelma</strong>
                    </p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; The Perfect Cup 2021 GHABI ANIS</p>
                </div>
            </div>
        </div>
    </footer>
